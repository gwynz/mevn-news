<template>
  <div id="canvas" class="relative">
    <header
      class="rounded w-1/3 cursor-pointer mx-auto hover:bg-teal-400 px-4 py-3 bg-primary text-white text-2xl font-bold text-center uppercase shadow-lg"
    >Bang tin</header>
    <div class="absolute flex justify-end mt-2 right-0 top-0 w-16 h-16 pr-10">
      ...
      <!--<div class="px-2 hover:text-primary cursor-pointer" @click="genaratePdf">Genarate Pdf</div>-->
    </div>
      ...
      >
        <svg viewBox="0 0 1440 190" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g stroke-width="2">
            ...
            <path d="M0 95.4893C650 -134.511 790 325.489 1440 95.4893" stroke="#4FD1C5" />
          </g>
        </svg>
        <svg
          class="mt-48 w-full"
    ...
    <footer class="w-full p-10 text-center bg-teal-100 mt-5">"Khong biet ghi gi"</footer>
  </div>
</template>
